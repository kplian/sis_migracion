...
CREATE OR REPLACE FUNCTION migracion.f_obtener_datos_tabla_sel (
...
BEGIN
    ...
    v_nombre_funcion:='migracion.f_obtener_datos_tabla_sel';
    ...
    if p_transaccion = 'GEN_COLUMN_SEL' then
    	...
    	begin
            ...
            v_sql = 'CREATE SEQUENCE migracion.ts_generador INCREMENT 1 MINVALUE 1START 1;';
            execute(v_sql);
            ...
            v_sql = 'insert into tt_tabla_metadatos( id,
                    ...
                    100, ''si'', 80, nextval(''migracion.ts_generador'')::smallint, 1::smallint
            ...
            --delete de sequence
            v_sql='drop sequence migracion.ts_generador;';
            execute(v_sql);
